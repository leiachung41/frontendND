  ...
  responsive_images: {
    myTask: {
      ...
      files: [{
        ...
        custom_dest: 'tmp/custom_dest/width' <<< from here this might be different orifinal copy cuz some error.
      }]
    }
  },
})
...
You can use width, height, name or path as a delimiter. <<< here, too.
